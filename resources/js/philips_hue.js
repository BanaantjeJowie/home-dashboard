...
/*
    ...
    DO NOT CHANGE THIS CODE (unless the ip address and user id)
*/
...
/*
    ...
    ipAddress = ip address of the Hue bridge
    user      = your generated user id
*/
const ipAddress = "10.10.1.30";
const user = "U1pV9mJXPRPjVORWDimYGWbzze7520jaqV6vUYSO";
/*
...
function getLampsInfo() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let response = yield window.fetch(`http://${ipAddress}/api/${user}/lights/`, { method: "GET" });
...
function getLightInfo(id) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield fetch("http://" + ipAddress + "/api/" + user + "/lights/" + id, { method: "GET" });
        let json = yield response.json();
        return yield json;
    });
}
...
function setLightState(id, state) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield fetch(`http://${ipAddress}/api/${user}/lights/${id}/state`, {
            method: "PUT",
...
function setLightColor(id, hue, bri, sat) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log(`Setting color of light ${id} to hue: ${hue}, brightness: ${bri}, saturation: ${sat}`);
        let response = yield fetch(`http://${ipAddress}/api/${user}/lights/${id}/state`, {
            method: "PUT",
...
function setLightBri(id, bri) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log(`Setting brightness of light ${id} to ${bri}`);
        let response = yield fetch(`http://${ipAddress}/api/${user}/lights/${id}/state`, {
            method: "PUT",
